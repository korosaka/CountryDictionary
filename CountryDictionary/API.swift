...
public final class CountryQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Country: GraphQLSelectionSet {
      ...
      public init(name: String, phone: String, emoji: String, capital: String? = nil, currency: String? = nil, languages: [Language], continent: Continent, states: [State]) {
        self.init(unsafeResultMap: ["__typename": "Country", "name": name, "phone": phone, "emoji": emoji, "capital": capital, "currency": currency, "languages": languages.map { (value: Language) -> ResultMap in value.resultMap }, "continent": continent.resultMap, "states": states.map { (value: State) -> ResultMap in value.resultMap }])
      }
